            ...
            try {
                ...
                if (response.data && Array.isArray(response.data.data)) {
                    const posts = response.data.data.map(post => {
                        const imageUrl = post.attributes.Image.data.attributes.url; // Extract the image URL from the response
                        ...
                        return {
                            ...
                            imageUrl: imageUrl, // Include the image URL in the blog post object
                        };
                    });
